...
# Setup a figure plotting area, with the right parameters.
    ...
    if title != None:
        fig.subplots_adjust(left=pad, right=0.95, top=0.94, bottom=0.12)
        plt.title(title)
    else:
...
def generate_plots(lines, fname, wr=20, title=None, oname='out', N=6, labels=None, offset=0.5, text_shift=0.2, out='n', figsize=[3.15,4], pad=0.15, v=0.0):
# Generate the plots.
    ### USAGE:
